...
class MenuHelper
{
    ...
    public static function getAdministrationItems(): array
    {
        return [
            [
                ...
                'path' => route('cities.index', absolute: false),
            ...
            [
                'icon' => 'user-gear',
                'name' => 'Roles',
                'path' => route('roles.index', absolute: false),
    ...
    public static function getMenuGroups(): array
    {
         $groups = [
            [
                'title' => 'Menu',
                'items' => self::filterMenuByPermission(self::getMainNavItems())
            ],
            [
                'title' => 'Administration',
                'items' => self::filterMenuByPermission(self::getAdministrationItems())
            ]
        ];
    ...
    public static function filterMenuByPermission(array $items): array
    {
        $user = Auth::user();
        ...
        return array_values(array_filter($items, function ($item) use ($user) {
            ...
            if (isset($item['subItems'])) {
                $item['subItems'] = array_values(array_filter($item['subItems'], function ($sub) use ($user) {
                    return !isset($sub['permission']) || $user->can($sub['permission']);
                }));

                // kung walang subItems after filter, hide parent
    ...
    public static function getIconSvg($iconName): string
    {
        $icons = [
            ...
            <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 0 1 0 3.75H5.625a1.875 1.875 0 0 1 0-3.75Z" /></svg>',

            'user-gear' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            'city' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            'show' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
