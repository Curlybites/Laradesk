...
@section('content')
    <x-common.page-breadcrumb pageTitle="Role Permissions" />
    ...
    <a href="{{ route('permissions.create') }}" class="inline-flex items-center text-inherit no-underline">
        <x-ui.button size="sm" variant="primary">Create Permission</x-ui.button>
    </a>
                    ...
                    <tbody>
                        @forelse ($permissions as $permission)
                            <tr class="border-b border-gray-100 dark:border-gray-800">
                                ...
                                <td class="px-5 py-4 sm:px-6">
                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $permission->created_at }}</p>
                                </td>
                                <td class="px-5 py-4 sm:px-6">
                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $permission->updated_at }}</p>
                                </td>
                                <td class="px-5 py-4 sm:px-6">
