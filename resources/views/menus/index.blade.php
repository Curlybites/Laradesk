...
@section('content')
    <x-common.page-breadcrumb pageTitle="Menus" />
    ...
    <div class="space-y-6">
        ...
        <a href="{{ route('menus.create') }}" class="inline-flex items-center text-inherit no-underline">
                        ...
                        @forelse ($menus as $menu)
                            <tr class="border-b border-gray-100 dark:border-gray-800">
                                <td class="px-5 py-4 sm:px-6">
                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $menu->name }}</p>
                                </td>
                                <td class="px-5 py-4 sm:px-6">
                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $menu->description }}</p>
                                </td>
                                <td class="px-5 py-4 sm:px-6">
                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $menu->created_at }}</p>
                                </td>
                                <td class="px-5 py-4 sm:px-6">
                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $menu->updated_at }}</p>
                                </td>
                                <td class="px-5 py-4 sm:px-6">
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="px-5 py-8 text-center">
                                    <p class="text-gray-500 dark:text-gray-400">No menus found.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
