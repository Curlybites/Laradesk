    ...
    @push('styles')
        ...
        <style>
            ...
            .fc .fc-button-primary:hover {
                background-color: var(--color-brand, #1d4ed8);
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                let calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    select: function(arg) {
                        console.log('Date selected:', arg.startStr, arg.endStr);
                        const modal = document.getElementById('eventModal');
                        if (modal) {
                            modal.classList.remove('hidden');
                            modal.classList.add('flex');
                            document.getElementById('event-start-date').value = arg.startStr.split('T')[0];
                            document.getElementById('event-end-date').value = arg.endStr.split('T')[0];
                            document.getElementById('event-title').value = '';
                            document.querySelector('.btn-update-event').style.display = 'none';
                            document.querySelector('.btn-add-event').style.display = 'flex';
                            
                            // Prevent text selection after date selection
                            calendar.unselect();
                        }
                    },
                    eventClick: function(arg) {
                        ...
                        if (modal) {
                            ...
                            document.getElementById('event-start-date').value = arg.event.startStr.split('T')[0];
                            document.getElementById('event-end-date').value = arg.event.endStr.split('T')[0];
                            document.querySelector('.btn-update-event').style.display = 'flex';
